...
public class HttpOperation {
	...
	public int loginJiao(String userIdText, String userPasswordText)
	        throws ClientProtocolException, IOException {
		httpPost = new HttpPost(
		        "http://sso.jwc.whut.edu.cn/Certification/login.do");
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(3);
		nameValuePairs
		        .add(new BasicNameValuePair("password", userPasswordText));
	...
	public void getJieYueHtml() throws ClientProtocolException,
	        UnsupportedEncodingException, IOException {
	...
	public void getXuJieHtml() throws ClientProtocolException,
	        UnsupportedEncodingException, IOException {
	...
	public String[][] getXuJieData() throws IndexOutOfBoundsException,
	...
	public void getXuJieSingleHtml(List<NameValuePair> nameValuePairs)
	        throws ClientProtocolException, IOException {
		// 点击续借按钮
		...
		httpPost.setHeader("Referer",
		        "http://202.114.89.11/opac/loan/renewList");
		HttpResponse response = httpClient.execute(httpPost);
		HttpEntity entity = response.getEntity();
		html = EntityUtils.toString(entity, "GB2312");
	}
	...
	public static void getCookie(HttpClient httpClient) {
		...
		if (cookies.isEmpty()) {
			...
			for (int i = 0; i < cookies.size(); i++) {
				if (cookies.get(i).getName().toString().equals("JSESSIONID")) {
					WhutGlobal.JSESSIONID = cookies.get(i).getValue()
					        .toString();
