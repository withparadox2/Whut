...
import com.withparadox2.whut.http.HttpRoomSearchThread;
...
public class KongJiaoShiActivity extends Activity {
	...
	class MyExpandableListAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(KongJiaoShiActivity.this)
				        .inflate(R.layout.jiaoshi_expandable_child, null);
				viewHolder = new ChildViewHolder();
				viewHolder.room_location1 = (TextView) convertView
				        .findViewById(R.id.room_location1);
				viewHolder.room_location2 = (TextView) convertView
				        .findViewById(R.id.room_location2);
				viewHolder.room_location3 = (TextView) convertView
				        .findViewById(R.id.room_location3);
				convertView.setTag(viewHolder);
			} else {
				viewHolder = (ChildViewHolder) convertView.getTag();
			}

			String[] s = WhutGlobal.ROOM_CHILD_LIST.get(groupPosition).get(
			        childPosition);
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(KongJiaoShiActivity.this)
				        .inflate(R.layout.jiaoshi_expandable_group, null);
				viewHolder = new GroupViewHolder();
				viewHolder.area_location = (TextView) convertView
				        .findViewById(R.id.area_location);
				convertView.setTag(viewHolder);
			} else {
				viewHolder = (GroupViewHolder) convertView.getTag();
			}
			viewHolder.area_location.setText(WhutGlobal.ROOM_GROUP_LIST
			        .get(groupPosition));
			return convertView;
		}
	...
	class UpdaetUIHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case START_DOWNLOADING:
				Toast.makeText(KongJiaoShiActivity.this, "开始下载",
				        Toast.LENGTH_SHORT).show();
				break;
			case START_PARSING:
				Toast.makeText(KongJiaoShiActivity.this, "开始解析",
				        Toast.LENGTH_SHORT).show();
				break;
