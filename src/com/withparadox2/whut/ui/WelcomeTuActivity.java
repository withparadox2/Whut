	...
	class JieYueOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			if (httpOperation.isConnect(WelcomeTuActivity.this)) {
				...
				myThread = new HttpOperateThread(WelcomeTuActivity.this,
				        myHandler, httpOperation);
				myThread.start();
			} else {
				Toast.makeText(WelcomeTuActivity.this, "貌似没有联网...",
		...
		public void handleMessage(Message msg) {
			...
			case 3:
				...
				if (WhutGlobal.JUMP_OR_NOT && (!cancelDialogByHand)) {
					...
					switch (WhutGlobal.WhichAction) {
					case 10:
						i.setClass(WelcomeTuActivity.this,
						        JieYueChaXunActivity.class);
						startActivity(i);
						break;
					case 11:
			...
			case 100:
				if (!cancelDialogByHand) {
					Toast.makeText(WelcomeTuActivity.this, "不好意思，数据有问题...",
					        Toast.LENGTH_LONG).show();
				}
				break;
			}
